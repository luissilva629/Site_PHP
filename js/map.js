$(function(){
	...
	function initialize() {
	  var mapProp = {
	    center:new google.maps.LatLng(-23.538660,-46.284790),
	    zoom:14,
	   	scrollwheel: false,
	     styles: [{
	    stylers: [{
	...
	initialize()
    addMarker(value.lat, value.long, '', 'Minha casa', false, true)
	...
	function carregarDinamico(){
		$('[realtime]').click(function(){
			...
			setTimeout(function(){
				initialize();
				addMarker(-23.538660,-46.284790,'',"Minha casa",undefined,false);
